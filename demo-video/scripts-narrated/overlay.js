...
(() => {
  ...
  #dv-progress > i {
    ...
    background: linear-gradient(90deg, var(--dv-a, #6366f1), var(--dv-b, #d4a12e));
  ...
  #dv-cap::before {
    ...
    background: linear-gradient(180deg, var(--dv-a, #8b5cf6), var(--dv-b, #d4a12e));
  }
  #dv-cap .t {
  ...
  #dv-card .rule {
    ...
    background: linear-gradient(90deg, var(--dv-a, #8b5cf6), var(--dv-b, #d4a12e));
  ...
  const mount = () => {
    ...
    window.__dv = {
      ...
      theme(from, to) {
        ...
        root.style.setProperty("--dv-a", from);
        root.style.setProperty("--dv-b", to);
        write({ theme: [from, to] });
      },
      progress(p) {
    ...
    const st = read();
    if (st.theme) window.__dv.theme(st.theme[0], st.theme[1]);
