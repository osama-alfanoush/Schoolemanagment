      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="space-y-4 rounded-lg border p-6 bg-card max-w-xl">
          ...
          <div className="space-y-2">
            ...
            <select className="w-full rounded-md border bg-background px-3 py-2 text-sm" value={staffId} onChange={(e) => setStaffId(Number(e.target.value) || "")}>
          ...
          <div className="space-y-2">
            ...
            <input className="w-full rounded-md border bg-background px-3 py-2 text-sm" placeholder="e.g. Q1 2026, Annual 2026" value={period} onChange={(e) => setPeriod(e.target.value)} />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium">Overall Rating: {rating}/5</label>
            <input type="range" min={1} max={5} step={1} value={rating} onChange={(e) => setRating(Number(e.target.value))} className="w-full accent-primary" />
          ...
          <div className="space-y-2">
            ...
            <textarea className="w-full rounded-md border bg-background px-3 py-2 text-sm min-h-[80px]" value={comments} onChange={(e) => setComments(e.target.value)} placeholder="Performance comments…" />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium">Goals for Next Period</label>
            <textarea className="w-full rounded-md border bg-background px-3 py-2 text-sm min-h-[60px]" value={goals} onChange={(e) => setGoals(e.target.value)} placeholder="Goals…" />
          </div>
