...
const ar: Bundle = {
  common: {
    ...
    resetLinkSent: "إذا كان البريد مسجلاً، فقد أُرسل رابط إعادة التعيين.",
  },
  tabs: {
    home: "الرئيسية",
    homework: "الواجبات",
