...
part of 'student_calendar200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$StudentCalendar200Response extends StudentCalendar200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<CalendarEvent> data;
  @override
  ...
  factory _$StudentCalendar200Response([
    void Function(StudentCalendar200ResponseBuilder)? updates,
  ]) => (StudentCalendar200ResponseBuilder()..update(updates))._build();

  _$StudentCalendar200Response._({
  ...
  @override
  StudentCalendar200Response rebuild(
    void Function(StudentCalendar200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  StudentCalendar200ResponseBuilder toBuilder() =>
      StudentCalendar200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is StudentCalendar200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'StudentCalendar200Response')
...
class StudentCalendar200ResponseBuilder
    implements
        Builder<StudentCalendar200Response, StudentCalendar200ResponseBuilder> {
  _$StudentCalendar200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<CalendarEvent>? _data;
  ListBuilder<CalendarEvent> get data =>
      _$this._data ??= ListBuilder<CalendarEvent>();
  set data(ListBuilder<CalendarEvent>? data) => _$this._data = data;
  ...
  StudentCalendar200ResponseBuilder() {
    StudentCalendar200Response._defaults(this);
  }

  StudentCalendar200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(StudentCalendar200Response other) {
    _$v = other as _$StudentCalendar200Response;
  }

  @override
  void update(void Function(StudentCalendar200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  StudentCalendar200Response build() => _build();

  _$StudentCalendar200Response _build() {
    _$StudentCalendar200Response _$result;
    try {
      _$result =
          _$v ??
          _$StudentCalendar200Response._(
