...
part of 'warehouse_index_items183200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexItems183200Response
    extends WarehouseIndexItems183200Response {
  @override
  ...
  factory _$WarehouseIndexItems183200Response([
    void Function(WarehouseIndexItems183200ResponseBuilder)? updates,
  ]) => (WarehouseIndexItems183200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexItems183200Response._({
  ...
  @override
  WarehouseIndexItems183200Response rebuild(
    void Function(WarehouseIndexItems183200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexItems183200ResponseBuilder toBuilder() =>
      WarehouseIndexItems183200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexItems183200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexItems183200Response')
...
class WarehouseIndexItems183200ResponseBuilder
    implements
        Builder<
          WarehouseIndexItems183200Response,
          WarehouseIndexItems183200ResponseBuilder
        > {
  _$WarehouseIndexItems183200Response? _$v;
  ...
  WarehouseIndexItems183200ResponseBuilder() {
    WarehouseIndexItems183200Response._defaults(this);
  }

  WarehouseIndexItems183200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexItems183200Response other) {
    _$v = other as _$WarehouseIndexItems183200Response;
  }
  ...
  @override
  WarehouseIndexItems183200Response build() => _build();

  _$WarehouseIndexItems183200Response _build() {
    _$WarehouseIndexItems183200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexItems183200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexItems183200Response',
              'currentPage',
            ),
            data: data.build(),
