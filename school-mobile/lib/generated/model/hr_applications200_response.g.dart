...
part of 'hr_applications200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrApplications200Response extends HrApplications200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<JobApplication> data;
  @override
  ...
  factory _$HrApplications200Response([
    void Function(HrApplications200ResponseBuilder)? updates,
  ]) => (HrApplications200ResponseBuilder()..update(updates))._build();

  _$HrApplications200Response._({
  ...
  @override
  HrApplications200Response rebuild(
    void Function(HrApplications200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrApplications200ResponseBuilder toBuilder() =>
      HrApplications200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrApplications200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrApplications200Response')
...
class HrApplications200ResponseBuilder
    implements
        Builder<HrApplications200Response, HrApplications200ResponseBuilder> {
  _$HrApplications200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<JobApplication>? _data;
  ListBuilder<JobApplication> get data =>
      _$this._data ??= ListBuilder<JobApplication>();
  set data(ListBuilder<JobApplication>? data) => _$this._data = data;
  ...
  HrApplications200ResponseBuilder() {
    HrApplications200Response._defaults(this);
  }

  HrApplications200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrApplications200Response other) {
    _$v = other as _$HrApplications200Response;
  }

  @override
  void update(void Function(HrApplications200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrApplications200Response build() => _build();

  _$HrApplications200Response _build() {
    _$HrApplications200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrApplications200Response._(
