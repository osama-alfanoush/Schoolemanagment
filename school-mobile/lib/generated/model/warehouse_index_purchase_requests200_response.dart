...
part 'warehouse_index_purchase_requests200_response.g.dart';
...
@BuiltValue()
abstract class WarehouseIndexPurchaseRequests200Response implements Built<WarehouseIndexPurchaseRequests200Response, WarehouseIndexPurchaseRequests200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<PurchaseRequest> get data;
  ...
  WarehouseIndexPurchaseRequests200Response._();

  factory WarehouseIndexPurchaseRequests200Response([void updates(WarehouseIndexPurchaseRequests200ResponseBuilder b)]) = _$WarehouseIndexPurchaseRequests200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WarehouseIndexPurchaseRequests200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WarehouseIndexPurchaseRequests200Response> get serializer => _$WarehouseIndexPurchaseRequests200ResponseSerializer();
}

class _$WarehouseIndexPurchaseRequests200ResponseSerializer implements PrimitiveSerializer<WarehouseIndexPurchaseRequests200Response> {
  @override
  final Iterable<Type> types = const [WarehouseIndexPurchaseRequests200Response, _$WarehouseIndexPurchaseRequests200Response];

  @override
  final String wireName = r'WarehouseIndexPurchaseRequests200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WarehouseIndexPurchaseRequests200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(PurchaseRequest)]),
    );
  ...
  void _deserializeProperties(
    ...
    required WarehouseIndexPurchaseRequests200ResponseBuilder result,
  ...
  @override
  WarehouseIndexPurchaseRequests200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WarehouseIndexPurchaseRequests200ResponseBuilder();
