...
part 'accounting_audit_trail200_response_data.g.dart';

/// Capped: an uncapped client-supplied page size lets one request materialise the whole table.
///
/// Properties:
/// * [currentPage] 
/// * [data] 
...
@BuiltValue()
abstract class AccountingAuditTrail200ResponseData implements Built<AccountingAuditTrail200ResponseData, AccountingAuditTrail200ResponseDataBuilder> {
  ...
  AccountingAuditTrail200ResponseData._();

  factory AccountingAuditTrail200ResponseData([void updates(AccountingAuditTrail200ResponseDataBuilder b)]) = _$AccountingAuditTrail200ResponseData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountingAuditTrail200ResponseDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountingAuditTrail200ResponseData> get serializer => _$AccountingAuditTrail200ResponseDataSerializer();
}

class _$AccountingAuditTrail200ResponseDataSerializer implements PrimitiveSerializer<AccountingAuditTrail200ResponseData> {
  @override
  final Iterable<Type> types = const [AccountingAuditTrail200ResponseData, _$AccountingAuditTrail200ResponseData];

  @override
  final String wireName = r'AccountingAuditTrail200ResponseData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccountingAuditTrail200ResponseData object, {
  ...
  void _deserializeProperties(
    ...
    required AccountingAuditTrail200ResponseDataBuilder result,
  ...
  @override
  AccountingAuditTrail200ResponseData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountingAuditTrail200ResponseDataBuilder();
