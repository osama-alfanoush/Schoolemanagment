...
part of 'procurement_index_goods_receipts200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ProcurementIndexGoodsReceipts200Response
    extends ProcurementIndexGoodsReceipts200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<GoodsReceipt> data;
  @override
  ...
  factory _$ProcurementIndexGoodsReceipts200Response([
    void Function(ProcurementIndexGoodsReceipts200ResponseBuilder)? updates,
  ]) => (ProcurementIndexGoodsReceipts200ResponseBuilder()..update(updates))
      ._build();

  _$ProcurementIndexGoodsReceipts200Response._({
  ...
  @override
  ProcurementIndexGoodsReceipts200Response rebuild(
    void Function(ProcurementIndexGoodsReceipts200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  ProcurementIndexGoodsReceipts200ResponseBuilder toBuilder() =>
      ProcurementIndexGoodsReceipts200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ProcurementIndexGoodsReceipts200Response &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ProcurementIndexGoodsReceipts200Response',
          )
...
class ProcurementIndexGoodsReceipts200ResponseBuilder
    implements
        Builder<
          ProcurementIndexGoodsReceipts200Response,
          ProcurementIndexGoodsReceipts200ResponseBuilder
        > {
  _$ProcurementIndexGoodsReceipts200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<GoodsReceipt>? _data;
  ListBuilder<GoodsReceipt> get data =>
      _$this._data ??= ListBuilder<GoodsReceipt>();
  set data(ListBuilder<GoodsReceipt>? data) => _$this._data = data;
  ...
  ProcurementIndexGoodsReceipts200ResponseBuilder() {
    ProcurementIndexGoodsReceipts200Response._defaults(this);
  }

  ProcurementIndexGoodsReceipts200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ProcurementIndexGoodsReceipts200Response other) {
    _$v = other as _$ProcurementIndexGoodsReceipts200Response;
  }
  ...
  @override
  ProcurementIndexGoodsReceipts200Response build() => _build();

  _$ProcurementIndexGoodsReceipts200Response _build() {
    _$ProcurementIndexGoodsReceipts200Response _$result;
    try {
      _$result =
          _$v ??
          _$ProcurementIndexGoodsReceipts200Response._(
