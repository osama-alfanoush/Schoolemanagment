...
part of 'library_all_borrowings200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$LibraryAllBorrowings200Response
    extends LibraryAllBorrowings200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<LibraryBorrowing> data;
  @override
  ...
  factory _$LibraryAllBorrowings200Response([
    void Function(LibraryAllBorrowings200ResponseBuilder)? updates,
  ]) => (LibraryAllBorrowings200ResponseBuilder()..update(updates))._build();

  _$LibraryAllBorrowings200Response._({
  ...
  @override
  LibraryAllBorrowings200Response rebuild(
    void Function(LibraryAllBorrowings200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  LibraryAllBorrowings200ResponseBuilder toBuilder() =>
      LibraryAllBorrowings200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LibraryAllBorrowings200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LibraryAllBorrowings200Response')
...
class LibraryAllBorrowings200ResponseBuilder
    implements
        Builder<
          LibraryAllBorrowings200Response,
          LibraryAllBorrowings200ResponseBuilder
        > {
  _$LibraryAllBorrowings200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<LibraryBorrowing>? _data;
  ListBuilder<LibraryBorrowing> get data =>
      _$this._data ??= ListBuilder<LibraryBorrowing>();
  set data(ListBuilder<LibraryBorrowing>? data) => _$this._data = data;
  ...
  LibraryAllBorrowings200ResponseBuilder() {
    LibraryAllBorrowings200Response._defaults(this);
  }

  LibraryAllBorrowings200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(LibraryAllBorrowings200Response other) {
    _$v = other as _$LibraryAllBorrowings200Response;
  }

  @override
  void update(void Function(LibraryAllBorrowings200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LibraryAllBorrowings200Response build() => _build();

  _$LibraryAllBorrowings200Response _build() {
    _$LibraryAllBorrowings200Response _$result;
    try {
      _$result =
          _$v ??
          _$LibraryAllBorrowings200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'LibraryAllBorrowings200Response',
              'currentPage',
            ),
            data: data.build(),
