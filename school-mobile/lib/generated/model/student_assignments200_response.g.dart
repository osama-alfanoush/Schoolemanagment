...
part of 'student_assignments200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$StudentAssignments200Response extends StudentAssignments200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<Assignment> data;
  @override
  ...
  factory _$StudentAssignments200Response([
    void Function(StudentAssignments200ResponseBuilder)? updates,
  ]) => (StudentAssignments200ResponseBuilder()..update(updates))._build();

  _$StudentAssignments200Response._({
  ...
  @override
  StudentAssignments200Response rebuild(
    void Function(StudentAssignments200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  StudentAssignments200ResponseBuilder toBuilder() =>
      StudentAssignments200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is StudentAssignments200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'StudentAssignments200Response')
...
class StudentAssignments200ResponseBuilder
    implements
        Builder<
          StudentAssignments200Response,
          StudentAssignments200ResponseBuilder
        > {
  _$StudentAssignments200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<Assignment>? _data;
  ListBuilder<Assignment> get data =>
      _$this._data ??= ListBuilder<Assignment>();
  set data(ListBuilder<Assignment>? data) => _$this._data = data;
  ...
  StudentAssignments200ResponseBuilder() {
    StudentAssignments200Response._defaults(this);
  }

  StudentAssignments200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(StudentAssignments200Response other) {
    _$v = other as _$StudentAssignments200Response;
  }

  @override
  void update(void Function(StudentAssignments200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  StudentAssignments200Response build() => _build();

  _$StudentAssignments200Response _build() {
    _$StudentAssignments200Response _$result;
    try {
      _$result =
          _$v ??
          _$StudentAssignments200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'StudentAssignments200Response',
              'currentPage',
            ),
            data: data.build(),
