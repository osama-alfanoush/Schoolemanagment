...
part of 'hr_payroll_contracts200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrPayrollContracts200Response extends HrPayrollContracts200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<EmployeeContract> data;
  @override
  ...
  factory _$HrPayrollContracts200Response([
    void Function(HrPayrollContracts200ResponseBuilder)? updates,
  ]) => (HrPayrollContracts200ResponseBuilder()..update(updates))._build();

  _$HrPayrollContracts200Response._({
  ...
  @override
  HrPayrollContracts200Response rebuild(
    void Function(HrPayrollContracts200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrPayrollContracts200ResponseBuilder toBuilder() =>
      HrPayrollContracts200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrPayrollContracts200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrPayrollContracts200Response')
...
class HrPayrollContracts200ResponseBuilder
    implements
        Builder<
          HrPayrollContracts200Response,
          HrPayrollContracts200ResponseBuilder
        > {
  _$HrPayrollContracts200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<EmployeeContract>? _data;
  ListBuilder<EmployeeContract> get data =>
      _$this._data ??= ListBuilder<EmployeeContract>();
  set data(ListBuilder<EmployeeContract>? data) => _$this._data = data;
  ...
  HrPayrollContracts200ResponseBuilder() {
    HrPayrollContracts200Response._defaults(this);
  }

  HrPayrollContracts200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrPayrollContracts200Response other) {
    _$v = other as _$HrPayrollContracts200Response;
  }

  @override
  void update(void Function(HrPayrollContracts200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrPayrollContracts200Response build() => _build();

  _$HrPayrollContracts200Response _build() {
    _$HrPayrollContracts200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrPayrollContracts200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'HrPayrollContracts200Response',
              'currentPage',
            ),
            data: data.build(),
