...
part of 'warehouse_index_items184200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexItems184200Response
    extends WarehouseIndexItems184200Response {
  @override
  ...
  factory _$WarehouseIndexItems184200Response([
    void Function(WarehouseIndexItems184200ResponseBuilder)? updates,
  ]) => (WarehouseIndexItems184200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexItems184200Response._({
  ...
  @override
  WarehouseIndexItems184200Response rebuild(
    void Function(WarehouseIndexItems184200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexItems184200ResponseBuilder toBuilder() =>
      WarehouseIndexItems184200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexItems184200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexItems184200Response')
...
class WarehouseIndexItems184200ResponseBuilder
    implements
        Builder<
          WarehouseIndexItems184200Response,
          WarehouseIndexItems184200ResponseBuilder
        > {
  _$WarehouseIndexItems184200Response? _$v;
  ...
  WarehouseIndexItems184200ResponseBuilder() {
    WarehouseIndexItems184200Response._defaults(this);
  }

  WarehouseIndexItems184200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexItems184200Response other) {
    _$v = other as _$WarehouseIndexItems184200Response;
  }
  ...
  @override
  WarehouseIndexItems184200Response build() => _build();

  _$WarehouseIndexItems184200Response _build() {
    _$WarehouseIndexItems184200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexItems184200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexItems184200Response',
              'currentPage',
            ),
            data: data.build(),
