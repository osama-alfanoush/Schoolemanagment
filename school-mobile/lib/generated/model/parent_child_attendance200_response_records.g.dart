...
part of 'parent_child_attendance200_response_records.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ParentChildAttendance200ResponseRecords
    extends ParentChildAttendance200ResponseRecords {
  @override
  final int currentPage;
  @override
  final BuiltList<AttendanceRecord> data;
  @override
  ...
  factory _$ParentChildAttendance200ResponseRecords([
    void Function(ParentChildAttendance200ResponseRecordsBuilder)? updates,
  ]) => (ParentChildAttendance200ResponseRecordsBuilder()..update(updates))
      ._build();

  _$ParentChildAttendance200ResponseRecords._({
  ...
  @override
  ParentChildAttendance200ResponseRecords rebuild(
    void Function(ParentChildAttendance200ResponseRecordsBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  ParentChildAttendance200ResponseRecordsBuilder toBuilder() =>
      ParentChildAttendance200ResponseRecordsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ParentChildAttendance200ResponseRecords &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ParentChildAttendance200ResponseRecords',
          )
...
class ParentChildAttendance200ResponseRecordsBuilder
    implements
        Builder<
          ParentChildAttendance200ResponseRecords,
          ParentChildAttendance200ResponseRecordsBuilder
        > {
  _$ParentChildAttendance200ResponseRecords? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<AttendanceRecord>? _data;
  ListBuilder<AttendanceRecord> get data =>
      _$this._data ??= ListBuilder<AttendanceRecord>();
  set data(ListBuilder<AttendanceRecord>? data) => _$this._data = data;
  ...
  ParentChildAttendance200ResponseRecordsBuilder() {
    ParentChildAttendance200ResponseRecords._defaults(this);
  }

  ParentChildAttendance200ResponseRecordsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ParentChildAttendance200ResponseRecords other) {
    _$v = other as _$ParentChildAttendance200ResponseRecords;
  }
  ...
  @override
  ParentChildAttendance200ResponseRecords build() => _build();

  _$ParentChildAttendance200ResponseRecords _build() {
    _$ParentChildAttendance200ResponseRecords _$result;
    try {
      _$result =
          _$v ??
          _$ParentChildAttendance200ResponseRecords._(
