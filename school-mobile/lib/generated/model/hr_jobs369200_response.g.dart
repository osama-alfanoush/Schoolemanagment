...
part of 'hr_jobs369200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrJobs369200Response extends HrJobs369200Response {
  @override
  ...
  factory _$HrJobs369200Response([
    void Function(HrJobs369200ResponseBuilder)? updates,
  ]) => (HrJobs369200ResponseBuilder()..update(updates))._build();

  _$HrJobs369200Response._({
  ...
  @override
  HrJobs369200Response rebuild(
    void Function(HrJobs369200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrJobs369200ResponseBuilder toBuilder() =>
      HrJobs369200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrJobs369200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrJobs369200Response')
...
class HrJobs369200ResponseBuilder
    implements Builder<HrJobs369200Response, HrJobs369200ResponseBuilder> {
  _$HrJobs369200Response? _$v;
  ...
  HrJobs369200ResponseBuilder() {
    HrJobs369200Response._defaults(this);
  }

  HrJobs369200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrJobs369200Response other) {
    _$v = other as _$HrJobs369200Response;
  }

  @override
  void update(void Function(HrJobs369200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrJobs369200Response build() => _build();

  _$HrJobs369200Response _build() {
    _$HrJobs369200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrJobs369200Response._(
