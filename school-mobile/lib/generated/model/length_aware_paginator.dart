...
part 'length_aware_paginator.g.dart';
...
@BuiltValue()
abstract class LengthAwarePaginator implements Built<LengthAwarePaginator, LengthAwarePaginatorBuilder> {
  ...
  LengthAwarePaginator._();

  factory LengthAwarePaginator([void updates(LengthAwarePaginatorBuilder b)]) = _$LengthAwarePaginator;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LengthAwarePaginatorBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LengthAwarePaginator> get serializer => _$LengthAwarePaginatorSerializer();
}

class _$LengthAwarePaginatorSerializer implements PrimitiveSerializer<LengthAwarePaginator> {
  @override
  final Iterable<Type> types = const [LengthAwarePaginator, _$LengthAwarePaginator];

  @override
  final String wireName = r'LengthAwarePaginator';
  ...
  void _deserializeProperties(
    ...
    required LengthAwarePaginatorBuilder result,
  ...
  @override
  LengthAwarePaginator deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LengthAwarePaginatorBuilder();
