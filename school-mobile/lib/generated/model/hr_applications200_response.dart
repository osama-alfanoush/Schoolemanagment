...
part 'hr_applications200_response.g.dart';
...
@BuiltValue()
abstract class HrApplications200Response implements Built<HrApplications200Response, HrApplications200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<JobApplication> get data;
  ...
  HrApplications200Response._();

  factory HrApplications200Response([void updates(HrApplications200ResponseBuilder b)]) = _$HrApplications200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrApplications200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrApplications200Response> get serializer => _$HrApplications200ResponseSerializer();
}

class _$HrApplications200ResponseSerializer implements PrimitiveSerializer<HrApplications200Response> {
  @override
  final Iterable<Type> types = const [HrApplications200Response, _$HrApplications200Response];

  @override
  final String wireName = r'HrApplications200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrApplications200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(JobApplication)]),
    );
  ...
  void _deserializeProperties(
    ...
    required HrApplications200ResponseBuilder result,
  ...
  @override
  HrApplications200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrApplications200ResponseBuilder();
