...
part 'installment_index_plans200_response.g.dart';
...
@BuiltValue()
abstract class InstallmentIndexPlans200Response implements Built<InstallmentIndexPlans200Response, InstallmentIndexPlans200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<PaymentPlan> get data;
  ...
  InstallmentIndexPlans200Response._();

  factory InstallmentIndexPlans200Response([void updates(InstallmentIndexPlans200ResponseBuilder b)]) = _$InstallmentIndexPlans200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InstallmentIndexPlans200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InstallmentIndexPlans200Response> get serializer => _$InstallmentIndexPlans200ResponseSerializer();
}

class _$InstallmentIndexPlans200ResponseSerializer implements PrimitiveSerializer<InstallmentIndexPlans200Response> {
  @override
  final Iterable<Type> types = const [InstallmentIndexPlans200Response, _$InstallmentIndexPlans200Response];

  @override
  final String wireName = r'InstallmentIndexPlans200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InstallmentIndexPlans200Response object, {
  ...
  void _deserializeProperties(
    ...
    required InstallmentIndexPlans200ResponseBuilder result,
  ...
  @override
  InstallmentIndexPlans200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InstallmentIndexPlans200ResponseBuilder();
