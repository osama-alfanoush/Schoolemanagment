...
part of 'admin_get_announcements200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AdminGetAnnouncements200Response
    extends AdminGetAnnouncements200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<Announcement> data;
  @override
  ...
  factory _$AdminGetAnnouncements200Response([
    void Function(AdminGetAnnouncements200ResponseBuilder)? updates,
  ]) => (AdminGetAnnouncements200ResponseBuilder()..update(updates))._build();

  _$AdminGetAnnouncements200Response._({
  ...
  @override
  AdminGetAnnouncements200Response rebuild(
    void Function(AdminGetAnnouncements200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  AdminGetAnnouncements200ResponseBuilder toBuilder() =>
      AdminGetAnnouncements200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AdminGetAnnouncements200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdminGetAnnouncements200Response')
...
class AdminGetAnnouncements200ResponseBuilder
    implements
        Builder<
          AdminGetAnnouncements200Response,
          AdminGetAnnouncements200ResponseBuilder
        > {
  _$AdminGetAnnouncements200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<Announcement>? _data;
  ListBuilder<Announcement> get data =>
      _$this._data ??= ListBuilder<Announcement>();
  set data(ListBuilder<Announcement>? data) => _$this._data = data;
  ...
  AdminGetAnnouncements200ResponseBuilder() {
    AdminGetAnnouncements200Response._defaults(this);
  }

  AdminGetAnnouncements200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AdminGetAnnouncements200Response other) {
    _$v = other as _$AdminGetAnnouncements200Response;
  }

  @override
  void update(void Function(AdminGetAnnouncements200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AdminGetAnnouncements200Response build() => _build();

  _$AdminGetAnnouncements200Response _build() {
    _$AdminGetAnnouncements200Response _$result;
    try {
      _$result =
          _$v ??
          _$AdminGetAnnouncements200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'AdminGetAnnouncements200Response',
              'currentPage',
            ),
            data: data.build(),
