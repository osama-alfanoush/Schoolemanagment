...
part 'procurement_index_goods_receipts200_response.g.dart';
...
@BuiltValue()
abstract class ProcurementIndexGoodsReceipts200Response implements Built<ProcurementIndexGoodsReceipts200Response, ProcurementIndexGoodsReceipts200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<GoodsReceipt> get data;
  ...
  ProcurementIndexGoodsReceipts200Response._();

  factory ProcurementIndexGoodsReceipts200Response([void updates(ProcurementIndexGoodsReceipts200ResponseBuilder b)]) = _$ProcurementIndexGoodsReceipts200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProcurementIndexGoodsReceipts200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProcurementIndexGoodsReceipts200Response> get serializer => _$ProcurementIndexGoodsReceipts200ResponseSerializer();
}

class _$ProcurementIndexGoodsReceipts200ResponseSerializer implements PrimitiveSerializer<ProcurementIndexGoodsReceipts200Response> {
  @override
  final Iterable<Type> types = const [ProcurementIndexGoodsReceipts200Response, _$ProcurementIndexGoodsReceipts200Response];

  @override
  final String wireName = r'ProcurementIndexGoodsReceipts200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ProcurementIndexGoodsReceipts200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(GoodsReceipt)]),
    );
  ...
  void _deserializeProperties(
    ...
    required ProcurementIndexGoodsReceipts200ResponseBuilder result,
  ...
  @override
  ProcurementIndexGoodsReceipts200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProcurementIndexGoodsReceipts200ResponseBuilder();
