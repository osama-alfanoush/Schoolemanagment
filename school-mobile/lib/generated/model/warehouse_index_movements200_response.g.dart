...
part of 'warehouse_index_movements200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexMovements200Response
    extends WarehouseIndexMovements200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<StockMovement> data;
  @override
  ...
  factory _$WarehouseIndexMovements200Response([
    void Function(WarehouseIndexMovements200ResponseBuilder)? updates,
  ]) => (WarehouseIndexMovements200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexMovements200Response._({
  ...
  @override
  WarehouseIndexMovements200Response rebuild(
    void Function(WarehouseIndexMovements200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexMovements200ResponseBuilder toBuilder() =>
      WarehouseIndexMovements200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexMovements200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexMovements200Response')
...
class WarehouseIndexMovements200ResponseBuilder
    implements
        Builder<
          WarehouseIndexMovements200Response,
          WarehouseIndexMovements200ResponseBuilder
        > {
  _$WarehouseIndexMovements200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<StockMovement>? _data;
  ListBuilder<StockMovement> get data =>
      _$this._data ??= ListBuilder<StockMovement>();
  set data(ListBuilder<StockMovement>? data) => _$this._data = data;
  ...
  WarehouseIndexMovements200ResponseBuilder() {
    WarehouseIndexMovements200Response._defaults(this);
  }

  WarehouseIndexMovements200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexMovements200Response other) {
    _$v = other as _$WarehouseIndexMovements200Response;
  }
  ...
  @override
  WarehouseIndexMovements200Response build() => _build();

  _$WarehouseIndexMovements200Response _build() {
    _$WarehouseIndexMovements200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexMovements200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexMovements200Response',
              'currentPage',
            ),
            data: data.build(),
