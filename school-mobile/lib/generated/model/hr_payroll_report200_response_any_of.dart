...
part 'hr_payroll_report200_response_any_of.g.dart';
...
@BuiltValue()
abstract class HrPayrollReport200ResponseAnyOf implements Built<HrPayrollReport200ResponseAnyOf, HrPayrollReport200ResponseAnyOfBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<StaffProfile> get data;
  ...
  HrPayrollReport200ResponseAnyOf._();

  factory HrPayrollReport200ResponseAnyOf([void updates(HrPayrollReport200ResponseAnyOfBuilder b)]) = _$HrPayrollReport200ResponseAnyOf;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrPayrollReport200ResponseAnyOfBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrPayrollReport200ResponseAnyOf> get serializer => _$HrPayrollReport200ResponseAnyOfSerializer();
}

class _$HrPayrollReport200ResponseAnyOfSerializer implements PrimitiveSerializer<HrPayrollReport200ResponseAnyOf> {
  @override
  final Iterable<Type> types = const [HrPayrollReport200ResponseAnyOf, _$HrPayrollReport200ResponseAnyOf];

  @override
  final String wireName = r'HrPayrollReport200ResponseAnyOf';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrPayrollReport200ResponseAnyOf object, {
  ...
  void _deserializeProperties(
    ...
    required HrPayrollReport200ResponseAnyOfBuilder result,
  ...
  @override
  HrPayrollReport200ResponseAnyOf deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrPayrollReport200ResponseAnyOfBuilder();
