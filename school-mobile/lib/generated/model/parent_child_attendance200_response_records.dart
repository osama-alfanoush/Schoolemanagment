...
part 'parent_child_attendance200_response_records.g.dart';
...
@BuiltValue()
abstract class ParentChildAttendance200ResponseRecords implements Built<ParentChildAttendance200ResponseRecords, ParentChildAttendance200ResponseRecordsBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<AttendanceRecord> get data;
  ...
  ParentChildAttendance200ResponseRecords._();

  factory ParentChildAttendance200ResponseRecords([void updates(ParentChildAttendance200ResponseRecordsBuilder b)]) = _$ParentChildAttendance200ResponseRecords;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ParentChildAttendance200ResponseRecordsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ParentChildAttendance200ResponseRecords> get serializer => _$ParentChildAttendance200ResponseRecordsSerializer();
}

class _$ParentChildAttendance200ResponseRecordsSerializer implements PrimitiveSerializer<ParentChildAttendance200ResponseRecords> {
  @override
  final Iterable<Type> types = const [ParentChildAttendance200ResponseRecords, _$ParentChildAttendance200ResponseRecords];

  @override
  final String wireName = r'ParentChildAttendance200ResponseRecords';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ParentChildAttendance200ResponseRecords object, {
  ...
  void _deserializeProperties(
    ...
    required ParentChildAttendance200ResponseRecordsBuilder result,
  ...
  @override
  ParentChildAttendance200ResponseRecords deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ParentChildAttendance200ResponseRecordsBuilder();
