...
part 'hr_payroll_warnings200_response.g.dart';
...
@BuiltValue()
abstract class HrPayrollWarnings200Response implements Built<HrPayrollWarnings200Response, HrPayrollWarnings200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<DisciplinaryWarning> get data;
  ...
  HrPayrollWarnings200Response._();

  factory HrPayrollWarnings200Response([void updates(HrPayrollWarnings200ResponseBuilder b)]) = _$HrPayrollWarnings200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrPayrollWarnings200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrPayrollWarnings200Response> get serializer => _$HrPayrollWarnings200ResponseSerializer();
}

class _$HrPayrollWarnings200ResponseSerializer implements PrimitiveSerializer<HrPayrollWarnings200Response> {
  @override
  final Iterable<Type> types = const [HrPayrollWarnings200Response, _$HrPayrollWarnings200Response];

  @override
  final String wireName = r'HrPayrollWarnings200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrPayrollWarnings200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(DisciplinaryWarning)]),
    );
  ...
  void _deserializeProperties(
    ...
    required HrPayrollWarnings200ResponseBuilder result,
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(DisciplinaryWarning)]),
          ) as BuiltList<DisciplinaryWarning>;
  ...
  @override
  HrPayrollWarnings200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrPayrollWarnings200ResponseBuilder();
