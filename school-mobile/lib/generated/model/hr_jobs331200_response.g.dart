...
part of 'hr_jobs331200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrJobs331200Response extends HrJobs331200Response {
  @override
  ...
  factory _$HrJobs331200Response([
    void Function(HrJobs331200ResponseBuilder)? updates,
  ]) => (HrJobs331200ResponseBuilder()..update(updates))._build();

  _$HrJobs331200Response._({
  ...
  @override
  HrJobs331200Response rebuild(
    void Function(HrJobs331200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrJobs331200ResponseBuilder toBuilder() =>
      HrJobs331200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrJobs331200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrJobs331200Response')
...
class HrJobs331200ResponseBuilder
    implements Builder<HrJobs331200Response, HrJobs331200ResponseBuilder> {
  _$HrJobs331200Response? _$v;
  ...
  HrJobs331200ResponseBuilder() {
    HrJobs331200Response._defaults(this);
  }

  HrJobs331200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrJobs331200Response other) {
    _$v = other as _$HrJobs331200Response;
  }

  @override
  void update(void Function(HrJobs331200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrJobs331200Response build() => _build();

  _$HrJobs331200Response _build() {
    _$HrJobs331200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrJobs331200Response._(
