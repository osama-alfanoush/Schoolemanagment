...
part of 'library_available_books200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$LibraryAvailableBooks200Response
    extends LibraryAvailableBooks200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<LibraryBook> data;
  @override
  ...
  factory _$LibraryAvailableBooks200Response([
    void Function(LibraryAvailableBooks200ResponseBuilder)? updates,
  ]) => (LibraryAvailableBooks200ResponseBuilder()..update(updates))._build();

  _$LibraryAvailableBooks200Response._({
  ...
  @override
  LibraryAvailableBooks200Response rebuild(
    void Function(LibraryAvailableBooks200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  LibraryAvailableBooks200ResponseBuilder toBuilder() =>
      LibraryAvailableBooks200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LibraryAvailableBooks200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LibraryAvailableBooks200Response')
...
class LibraryAvailableBooks200ResponseBuilder
    implements
        Builder<
          LibraryAvailableBooks200Response,
          LibraryAvailableBooks200ResponseBuilder
        > {
  _$LibraryAvailableBooks200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<LibraryBook>? _data;
  ListBuilder<LibraryBook> get data =>
      _$this._data ??= ListBuilder<LibraryBook>();
  set data(ListBuilder<LibraryBook>? data) => _$this._data = data;
  ...
  LibraryAvailableBooks200ResponseBuilder() {
    LibraryAvailableBooks200Response._defaults(this);
  }

  LibraryAvailableBooks200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(LibraryAvailableBooks200Response other) {
    _$v = other as _$LibraryAvailableBooks200Response;
  }

  @override
  void update(void Function(LibraryAvailableBooks200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LibraryAvailableBooks200Response build() => _build();

  _$LibraryAvailableBooks200Response _build() {
    _$LibraryAvailableBooks200Response _$result;
    try {
      _$result =
          _$v ??
          _$LibraryAvailableBooks200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'LibraryAvailableBooks200Response',
              'currentPage',
            ),
            data: data.build(),
