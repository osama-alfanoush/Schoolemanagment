...
part of 'admin_hr_requests200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AdminHrRequests200Response extends AdminHrRequests200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<HrRequest> data;
  @override
  ...
  factory _$AdminHrRequests200Response([
    void Function(AdminHrRequests200ResponseBuilder)? updates,
  ]) => (AdminHrRequests200ResponseBuilder()..update(updates))._build();

  _$AdminHrRequests200Response._({
  ...
  @override
  AdminHrRequests200Response rebuild(
    void Function(AdminHrRequests200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  AdminHrRequests200ResponseBuilder toBuilder() =>
      AdminHrRequests200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AdminHrRequests200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdminHrRequests200Response')
...
class AdminHrRequests200ResponseBuilder
    implements
        Builder<AdminHrRequests200Response, AdminHrRequests200ResponseBuilder> {
  _$AdminHrRequests200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<HrRequest>? _data;
  ListBuilder<HrRequest> get data => _$this._data ??= ListBuilder<HrRequest>();
  set data(ListBuilder<HrRequest>? data) => _$this._data = data;
  ...
  AdminHrRequests200ResponseBuilder() {
    AdminHrRequests200Response._defaults(this);
  }

  AdminHrRequests200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AdminHrRequests200Response other) {
    _$v = other as _$AdminHrRequests200Response;
  }

  @override
  void update(void Function(AdminHrRequests200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AdminHrRequests200Response build() => _build();

  _$AdminHrRequests200Response _build() {
    _$AdminHrRequests200Response _$result;
    try {
      _$result =
          _$v ??
          _$AdminHrRequests200Response._(
