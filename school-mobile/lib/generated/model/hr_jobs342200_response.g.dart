...
part of 'hr_jobs342200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrJobs342200Response extends HrJobs342200Response {
  @override
  ...
  factory _$HrJobs342200Response([
    void Function(HrJobs342200ResponseBuilder)? updates,
  ]) => (HrJobs342200ResponseBuilder()..update(updates))._build();

  _$HrJobs342200Response._({
  ...
  @override
  HrJobs342200Response rebuild(
    void Function(HrJobs342200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrJobs342200ResponseBuilder toBuilder() =>
      HrJobs342200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrJobs342200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrJobs342200Response')
...
class HrJobs342200ResponseBuilder
    implements Builder<HrJobs342200Response, HrJobs342200ResponseBuilder> {
  _$HrJobs342200Response? _$v;
  ...
  HrJobs342200ResponseBuilder() {
    HrJobs342200Response._defaults(this);
  }

  HrJobs342200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrJobs342200Response other) {
    _$v = other as _$HrJobs342200Response;
  }

  @override
  void update(void Function(HrJobs342200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrJobs342200Response build() => _build();

  _$HrJobs342200Response _build() {
    _$HrJobs342200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrJobs342200Response._(
