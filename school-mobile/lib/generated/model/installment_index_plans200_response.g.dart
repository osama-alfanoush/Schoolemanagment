...
part of 'installment_index_plans200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$InstallmentIndexPlans200Response
    extends InstallmentIndexPlans200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<PaymentPlan> data;
  @override
  ...
  factory _$InstallmentIndexPlans200Response([
    void Function(InstallmentIndexPlans200ResponseBuilder)? updates,
  ]) => (InstallmentIndexPlans200ResponseBuilder()..update(updates))._build();

  _$InstallmentIndexPlans200Response._({
  ...
  @override
  InstallmentIndexPlans200Response rebuild(
    void Function(InstallmentIndexPlans200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  InstallmentIndexPlans200ResponseBuilder toBuilder() =>
      InstallmentIndexPlans200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is InstallmentIndexPlans200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'InstallmentIndexPlans200Response')
...
class InstallmentIndexPlans200ResponseBuilder
    implements
        Builder<
          InstallmentIndexPlans200Response,
          InstallmentIndexPlans200ResponseBuilder
        > {
  _$InstallmentIndexPlans200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<PaymentPlan>? _data;
  ListBuilder<PaymentPlan> get data =>
      _$this._data ??= ListBuilder<PaymentPlan>();
  set data(ListBuilder<PaymentPlan>? data) => _$this._data = data;
  ...
  InstallmentIndexPlans200ResponseBuilder() {
    InstallmentIndexPlans200Response._defaults(this);
  }

  InstallmentIndexPlans200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(InstallmentIndexPlans200Response other) {
    _$v = other as _$InstallmentIndexPlans200Response;
  }

  @override
  void update(void Function(InstallmentIndexPlans200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  InstallmentIndexPlans200Response build() => _build();

  _$InstallmentIndexPlans200Response _build() {
    _$InstallmentIndexPlans200Response _$result;
    try {
      _$result =
          _$v ??
          _$InstallmentIndexPlans200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'InstallmentIndexPlans200Response',
              'currentPage',
            ),
            data: data.build(),
