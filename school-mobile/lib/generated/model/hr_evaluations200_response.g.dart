...
part of 'hr_evaluations200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrEvaluations200Response extends HrEvaluations200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<PerformanceEvaluation> data;
  @override
  ...
  factory _$HrEvaluations200Response([
    void Function(HrEvaluations200ResponseBuilder)? updates,
  ]) => (HrEvaluations200ResponseBuilder()..update(updates))._build();

  _$HrEvaluations200Response._({
  ...
  @override
  HrEvaluations200Response rebuild(
    void Function(HrEvaluations200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrEvaluations200ResponseBuilder toBuilder() =>
      HrEvaluations200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrEvaluations200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrEvaluations200Response')
...
class HrEvaluations200ResponseBuilder
    implements
        Builder<HrEvaluations200Response, HrEvaluations200ResponseBuilder> {
  _$HrEvaluations200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<PerformanceEvaluation>? _data;
  ListBuilder<PerformanceEvaluation> get data =>
      _$this._data ??= ListBuilder<PerformanceEvaluation>();
  set data(ListBuilder<PerformanceEvaluation>? data) => _$this._data = data;
  ...
  HrEvaluations200ResponseBuilder() {
    HrEvaluations200Response._defaults(this);
  }

  HrEvaluations200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrEvaluations200Response other) {
    _$v = other as _$HrEvaluations200Response;
  }

  @override
  void update(void Function(HrEvaluations200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrEvaluations200Response build() => _build();

  _$HrEvaluations200Response _build() {
    _$HrEvaluations200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrEvaluations200Response._(
