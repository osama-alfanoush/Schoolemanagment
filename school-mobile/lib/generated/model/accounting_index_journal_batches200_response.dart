...
part 'accounting_index_journal_batches200_response.g.dart';
...
@BuiltValue()
abstract class AccountingIndexJournalBatches200Response implements Built<AccountingIndexJournalBatches200Response, AccountingIndexJournalBatches200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<JournalBatch> get data;
  ...
  AccountingIndexJournalBatches200Response._();

  factory AccountingIndexJournalBatches200Response([void updates(AccountingIndexJournalBatches200ResponseBuilder b)]) = _$AccountingIndexJournalBatches200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountingIndexJournalBatches200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountingIndexJournalBatches200Response> get serializer => _$AccountingIndexJournalBatches200ResponseSerializer();
}

class _$AccountingIndexJournalBatches200ResponseSerializer implements PrimitiveSerializer<AccountingIndexJournalBatches200Response> {
  @override
  final Iterable<Type> types = const [AccountingIndexJournalBatches200Response, _$AccountingIndexJournalBatches200Response];

  @override
  final String wireName = r'AccountingIndexJournalBatches200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccountingIndexJournalBatches200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(JournalBatch)]),
    );
  ...
  void _deserializeProperties(
    ...
    required AccountingIndexJournalBatches200ResponseBuilder result,
  ...
  @override
  AccountingIndexJournalBatches200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountingIndexJournalBatches200ResponseBuilder();
