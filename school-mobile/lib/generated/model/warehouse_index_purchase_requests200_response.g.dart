...
part of 'warehouse_index_purchase_requests200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexPurchaseRequests200Response
    extends WarehouseIndexPurchaseRequests200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<PurchaseRequest> data;
  @override
  ...
  factory _$WarehouseIndexPurchaseRequests200Response([
    void Function(WarehouseIndexPurchaseRequests200ResponseBuilder)? updates,
  ]) => (WarehouseIndexPurchaseRequests200ResponseBuilder()..update(updates))
      ._build();

  _$WarehouseIndexPurchaseRequests200Response._({
  ...
  @override
  WarehouseIndexPurchaseRequests200Response rebuild(
    void Function(WarehouseIndexPurchaseRequests200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexPurchaseRequests200ResponseBuilder toBuilder() =>
      WarehouseIndexPurchaseRequests200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexPurchaseRequests200Response &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'WarehouseIndexPurchaseRequests200Response',
          )
...
class WarehouseIndexPurchaseRequests200ResponseBuilder
    implements
        Builder<
          WarehouseIndexPurchaseRequests200Response,
          WarehouseIndexPurchaseRequests200ResponseBuilder
        > {
  _$WarehouseIndexPurchaseRequests200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<PurchaseRequest>? _data;
  ListBuilder<PurchaseRequest> get data =>
      _$this._data ??= ListBuilder<PurchaseRequest>();
  set data(ListBuilder<PurchaseRequest>? data) => _$this._data = data;
  ...
  WarehouseIndexPurchaseRequests200ResponseBuilder() {
    WarehouseIndexPurchaseRequests200Response._defaults(this);
  }

  WarehouseIndexPurchaseRequests200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexPurchaseRequests200Response other) {
    _$v = other as _$WarehouseIndexPurchaseRequests200Response;
  }
  ...
  @override
  WarehouseIndexPurchaseRequests200Response build() => _build();

  _$WarehouseIndexPurchaseRequests200Response _build() {
    _$WarehouseIndexPurchaseRequests200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexPurchaseRequests200Response._(
