...
part 'procurement_index_purchase_orders200_response.g.dart';
...
@BuiltValue()
abstract class ProcurementIndexPurchaseOrders200Response implements Built<ProcurementIndexPurchaseOrders200Response, ProcurementIndexPurchaseOrders200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<PurchaseOrder> get data;
  ...
  ProcurementIndexPurchaseOrders200Response._();

  factory ProcurementIndexPurchaseOrders200Response([void updates(ProcurementIndexPurchaseOrders200ResponseBuilder b)]) = _$ProcurementIndexPurchaseOrders200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProcurementIndexPurchaseOrders200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProcurementIndexPurchaseOrders200Response> get serializer => _$ProcurementIndexPurchaseOrders200ResponseSerializer();
}

class _$ProcurementIndexPurchaseOrders200ResponseSerializer implements PrimitiveSerializer<ProcurementIndexPurchaseOrders200Response> {
  @override
  final Iterable<Type> types = const [ProcurementIndexPurchaseOrders200Response, _$ProcurementIndexPurchaseOrders200Response];

  @override
  final String wireName = r'ProcurementIndexPurchaseOrders200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ProcurementIndexPurchaseOrders200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(PurchaseOrder)]),
    );
  ...
  void _deserializeProperties(
    ...
    required ProcurementIndexPurchaseOrders200ResponseBuilder result,
  ...
  @override
  ProcurementIndexPurchaseOrders200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProcurementIndexPurchaseOrders200ResponseBuilder();
