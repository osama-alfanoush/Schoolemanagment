...
part 'procurement_finance_index_invoices200_response.g.dart';
...
@BuiltValue()
abstract class ProcurementFinanceIndexInvoices200Response implements Built<ProcurementFinanceIndexInvoices200Response, ProcurementFinanceIndexInvoices200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<SupplierInvoice> get data;
  ...
  ProcurementFinanceIndexInvoices200Response._();

  factory ProcurementFinanceIndexInvoices200Response([void updates(ProcurementFinanceIndexInvoices200ResponseBuilder b)]) = _$ProcurementFinanceIndexInvoices200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProcurementFinanceIndexInvoices200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProcurementFinanceIndexInvoices200Response> get serializer => _$ProcurementFinanceIndexInvoices200ResponseSerializer();
}

class _$ProcurementFinanceIndexInvoices200ResponseSerializer implements PrimitiveSerializer<ProcurementFinanceIndexInvoices200Response> {
  @override
  final Iterable<Type> types = const [ProcurementFinanceIndexInvoices200Response, _$ProcurementFinanceIndexInvoices200Response];

  @override
  final String wireName = r'ProcurementFinanceIndexInvoices200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ProcurementFinanceIndexInvoices200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(SupplierInvoice)]),
    );
  ...
  void _deserializeProperties(
    ...
    required ProcurementFinanceIndexInvoices200ResponseBuilder result,
  ...
  @override
  ProcurementFinanceIndexInvoices200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProcurementFinanceIndexInvoices200ResponseBuilder();
