...
part 'hr_payroll_contracts200_response.g.dart';
...
@BuiltValue()
abstract class HrPayrollContracts200Response implements Built<HrPayrollContracts200Response, HrPayrollContracts200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<EmployeeContract> get data;
  ...
  HrPayrollContracts200Response._();

  factory HrPayrollContracts200Response([void updates(HrPayrollContracts200ResponseBuilder b)]) = _$HrPayrollContracts200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrPayrollContracts200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrPayrollContracts200Response> get serializer => _$HrPayrollContracts200ResponseSerializer();
}

class _$HrPayrollContracts200ResponseSerializer implements PrimitiveSerializer<HrPayrollContracts200Response> {
  @override
  final Iterable<Type> types = const [HrPayrollContracts200Response, _$HrPayrollContracts200Response];

  @override
  final String wireName = r'HrPayrollContracts200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrPayrollContracts200Response object, {
  ...
  void _deserializeProperties(
    ...
    required HrPayrollContracts200ResponseBuilder result,
  ...
  @override
  HrPayrollContracts200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrPayrollContracts200ResponseBuilder();
