...
part of 'warehouse_index_items200200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexItems200200Response
    extends WarehouseIndexItems200200Response {
  @override
  ...
  factory _$WarehouseIndexItems200200Response([
    void Function(WarehouseIndexItems200200ResponseBuilder)? updates,
  ]) => (WarehouseIndexItems200200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexItems200200Response._({
  ...
  @override
  WarehouseIndexItems200200Response rebuild(
    void Function(WarehouseIndexItems200200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexItems200200ResponseBuilder toBuilder() =>
      WarehouseIndexItems200200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexItems200200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexItems200200Response')
...
class WarehouseIndexItems200200ResponseBuilder
    implements
        Builder<
          WarehouseIndexItems200200Response,
          WarehouseIndexItems200200ResponseBuilder
        > {
  _$WarehouseIndexItems200200Response? _$v;
  ...
  WarehouseIndexItems200200ResponseBuilder() {
    WarehouseIndexItems200200Response._defaults(this);
  }

  WarehouseIndexItems200200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexItems200200Response other) {
    _$v = other as _$WarehouseIndexItems200200Response;
  }
  ...
  @override
  WarehouseIndexItems200200Response build() => _build();

  _$WarehouseIndexItems200200Response _build() {
    _$WarehouseIndexItems200200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexItems200200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexItems200200Response',
              'currentPage',
            ),
            data: data.build(),
