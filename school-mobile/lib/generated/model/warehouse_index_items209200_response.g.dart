...
part of 'warehouse_index_items209200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexItems209200Response
    extends WarehouseIndexItems209200Response {
  @override
  ...
  factory _$WarehouseIndexItems209200Response([
    void Function(WarehouseIndexItems209200ResponseBuilder)? updates,
  ]) => (WarehouseIndexItems209200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexItems209200Response._({
  ...
  @override
  WarehouseIndexItems209200Response rebuild(
    void Function(WarehouseIndexItems209200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexItems209200ResponseBuilder toBuilder() =>
      WarehouseIndexItems209200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexItems209200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexItems209200Response')
...
class WarehouseIndexItems209200ResponseBuilder
    implements
        Builder<
          WarehouseIndexItems209200Response,
          WarehouseIndexItems209200ResponseBuilder
        > {
  _$WarehouseIndexItems209200Response? _$v;
  ...
  WarehouseIndexItems209200ResponseBuilder() {
    WarehouseIndexItems209200Response._defaults(this);
  }

  WarehouseIndexItems209200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexItems209200Response other) {
    _$v = other as _$WarehouseIndexItems209200Response;
  }
  ...
  @override
  WarehouseIndexItems209200Response build() => _build();

  _$WarehouseIndexItems209200Response _build() {
    _$WarehouseIndexItems209200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexItems209200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexItems209200Response',
              'currentPage',
            ),
            data: data.build(),
