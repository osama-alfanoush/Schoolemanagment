...
part of 'admin_audit_logs200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AdminAuditLogs200Response extends AdminAuditLogs200Response {
  @override
  ...
  factory _$AdminAuditLogs200Response([
    void Function(AdminAuditLogs200ResponseBuilder)? updates,
  ]) => (AdminAuditLogs200ResponseBuilder()..update(updates))._build();

  _$AdminAuditLogs200Response._({
  ...
  @override
  AdminAuditLogs200Response rebuild(
    void Function(AdminAuditLogs200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  AdminAuditLogs200ResponseBuilder toBuilder() =>
      AdminAuditLogs200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AdminAuditLogs200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdminAuditLogs200Response')
...
class AdminAuditLogs200ResponseBuilder
    implements
        Builder<AdminAuditLogs200Response, AdminAuditLogs200ResponseBuilder> {
  _$AdminAuditLogs200Response? _$v;
  ...
  AdminAuditLogs200ResponseBuilder() {
    AdminAuditLogs200Response._defaults(this);
  }

  AdminAuditLogs200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AdminAuditLogs200Response other) {
    _$v = other as _$AdminAuditLogs200Response;
  }

  @override
  void update(void Function(AdminAuditLogs200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AdminAuditLogs200Response build() => _build();

  _$AdminAuditLogs200Response _build() {
    _$AdminAuditLogs200Response _$result;
    try {
      _$result =
          _$v ??
          _$AdminAuditLogs200Response._(
