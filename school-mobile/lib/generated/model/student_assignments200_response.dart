...
part 'student_assignments200_response.g.dart';
...
@BuiltValue()
abstract class StudentAssignments200Response implements Built<StudentAssignments200Response, StudentAssignments200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<Assignment> get data;
  ...
  StudentAssignments200Response._();

  factory StudentAssignments200Response([void updates(StudentAssignments200ResponseBuilder b)]) = _$StudentAssignments200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StudentAssignments200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StudentAssignments200Response> get serializer => _$StudentAssignments200ResponseSerializer();
}

class _$StudentAssignments200ResponseSerializer implements PrimitiveSerializer<StudentAssignments200Response> {
  @override
  final Iterable<Type> types = const [StudentAssignments200Response, _$StudentAssignments200Response];

  @override
  final String wireName = r'StudentAssignments200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    StudentAssignments200Response object, {
  ...
  void _deserializeProperties(
    ...
    required StudentAssignments200ResponseBuilder result,
  ...
  @override
  StudentAssignments200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StudentAssignments200ResponseBuilder();
