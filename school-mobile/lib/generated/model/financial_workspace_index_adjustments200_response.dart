...
part 'financial_workspace_index_adjustments200_response.g.dart';
...
@BuiltValue()
abstract class FinancialWorkspaceIndexAdjustments200Response implements Built<FinancialWorkspaceIndexAdjustments200Response, FinancialWorkspaceIndexAdjustments200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<StudentFinancialAdjustment> get data;
  ...
  FinancialWorkspaceIndexAdjustments200Response._();

  factory FinancialWorkspaceIndexAdjustments200Response([void updates(FinancialWorkspaceIndexAdjustments200ResponseBuilder b)]) = _$FinancialWorkspaceIndexAdjustments200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FinancialWorkspaceIndexAdjustments200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FinancialWorkspaceIndexAdjustments200Response> get serializer => _$FinancialWorkspaceIndexAdjustments200ResponseSerializer();
}

class _$FinancialWorkspaceIndexAdjustments200ResponseSerializer implements PrimitiveSerializer<FinancialWorkspaceIndexAdjustments200Response> {
  @override
  final Iterable<Type> types = const [FinancialWorkspaceIndexAdjustments200Response, _$FinancialWorkspaceIndexAdjustments200Response];

  @override
  final String wireName = r'FinancialWorkspaceIndexAdjustments200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    FinancialWorkspaceIndexAdjustments200Response object, {
  ...
  void _deserializeProperties(
    ...
    required FinancialWorkspaceIndexAdjustments200ResponseBuilder result,
  ...
  @override
  FinancialWorkspaceIndexAdjustments200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FinancialWorkspaceIndexAdjustments200ResponseBuilder();
