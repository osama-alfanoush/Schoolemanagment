...
part of 'warehouse_index_items195200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexItems195200Response
    extends WarehouseIndexItems195200Response {
  @override
  ...
  factory _$WarehouseIndexItems195200Response([
    void Function(WarehouseIndexItems195200ResponseBuilder)? updates,
  ]) => (WarehouseIndexItems195200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexItems195200Response._({
  ...
  @override
  WarehouseIndexItems195200Response rebuild(
    void Function(WarehouseIndexItems195200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexItems195200ResponseBuilder toBuilder() =>
      WarehouseIndexItems195200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexItems195200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexItems195200Response')
...
class WarehouseIndexItems195200ResponseBuilder
    implements
        Builder<
          WarehouseIndexItems195200Response,
          WarehouseIndexItems195200ResponseBuilder
        > {
  _$WarehouseIndexItems195200Response? _$v;
  ...
  WarehouseIndexItems195200ResponseBuilder() {
    WarehouseIndexItems195200Response._defaults(this);
  }

  WarehouseIndexItems195200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexItems195200Response other) {
    _$v = other as _$WarehouseIndexItems195200Response;
  }
  ...
  @override
  WarehouseIndexItems195200Response build() => _build();

  _$WarehouseIndexItems195200Response _build() {
    _$WarehouseIndexItems195200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexItems195200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexItems195200Response',
              'currentPage',
            ),
            data: data.build(),
