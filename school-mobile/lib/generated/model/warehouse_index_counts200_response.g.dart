...
part of 'warehouse_index_counts200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexCounts200Response
    extends WarehouseIndexCounts200Response {
  @override
  ...
  factory _$WarehouseIndexCounts200Response([
    void Function(WarehouseIndexCounts200ResponseBuilder)? updates,
  ]) => (WarehouseIndexCounts200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexCounts200Response._({
  ...
  @override
  WarehouseIndexCounts200Response rebuild(
    void Function(WarehouseIndexCounts200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexCounts200ResponseBuilder toBuilder() =>
      WarehouseIndexCounts200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexCounts200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexCounts200Response')
...
class WarehouseIndexCounts200ResponseBuilder
    implements
        Builder<
          WarehouseIndexCounts200Response,
          WarehouseIndexCounts200ResponseBuilder
        > {
  _$WarehouseIndexCounts200Response? _$v;
  ...
  WarehouseIndexCounts200ResponseBuilder() {
    WarehouseIndexCounts200Response._defaults(this);
  }

  WarehouseIndexCounts200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexCounts200Response other) {
    _$v = other as _$WarehouseIndexCounts200Response;
  }

  @override
  void update(void Function(WarehouseIndexCounts200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  WarehouseIndexCounts200Response build() => _build();

  _$WarehouseIndexCounts200Response _build() {
    _$WarehouseIndexCounts200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexCounts200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexCounts200Response',
              'currentPage',
            ),
            data: data.build(),
