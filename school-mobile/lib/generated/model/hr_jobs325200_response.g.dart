...
part of 'hr_jobs325200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrJobs325200Response extends HrJobs325200Response {
  @override
  ...
  factory _$HrJobs325200Response([
    void Function(HrJobs325200ResponseBuilder)? updates,
  ]) => (HrJobs325200ResponseBuilder()..update(updates))._build();

  _$HrJobs325200Response._({
  ...
  @override
  HrJobs325200Response rebuild(
    void Function(HrJobs325200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrJobs325200ResponseBuilder toBuilder() =>
      HrJobs325200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrJobs325200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrJobs325200Response')
...
class HrJobs325200ResponseBuilder
    implements Builder<HrJobs325200Response, HrJobs325200ResponseBuilder> {
  _$HrJobs325200Response? _$v;
  ...
  HrJobs325200ResponseBuilder() {
    HrJobs325200Response._defaults(this);
  }

  HrJobs325200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrJobs325200Response other) {
    _$v = other as _$HrJobs325200Response;
  }

  @override
  void update(void Function(HrJobs325200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrJobs325200Response build() => _build();

  _$HrJobs325200Response _build() {
    _$HrJobs325200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrJobs325200Response._(
