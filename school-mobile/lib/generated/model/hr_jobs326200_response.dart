...
part 'hr_jobs326200_response.g.dart';
...
@BuiltValue()
abstract class HrJobs326200Response implements Built<HrJobs326200Response, HrJobs326200ResponseBuilder> {
  ...
  HrJobs326200Response._();

  factory HrJobs326200Response([void updates(HrJobs326200ResponseBuilder b)]) = _$HrJobs326200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrJobs326200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrJobs326200Response> get serializer => _$HrJobs326200ResponseSerializer();
}

class _$HrJobs326200ResponseSerializer implements PrimitiveSerializer<HrJobs326200Response> {
  @override
  final Iterable<Type> types = const [HrJobs326200Response, _$HrJobs326200Response];

  @override
  final String wireName = r'HrJobs326200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrJobs326200Response object, {
  ...
  void _deserializeProperties(
    ...
    required HrJobs326200ResponseBuilder result,
  ...
  @override
  HrJobs326200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrJobs326200ResponseBuilder();
