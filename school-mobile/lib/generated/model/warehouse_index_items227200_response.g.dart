...
part of 'warehouse_index_items227200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexItems227200Response
    extends WarehouseIndexItems227200Response {
  @override
  ...
  factory _$WarehouseIndexItems227200Response([
    void Function(WarehouseIndexItems227200ResponseBuilder)? updates,
  ]) => (WarehouseIndexItems227200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexItems227200Response._({
  ...
  @override
  WarehouseIndexItems227200Response rebuild(
    void Function(WarehouseIndexItems227200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexItems227200ResponseBuilder toBuilder() =>
      WarehouseIndexItems227200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexItems227200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexItems227200Response')
...
class WarehouseIndexItems227200ResponseBuilder
    implements
        Builder<
          WarehouseIndexItems227200Response,
          WarehouseIndexItems227200ResponseBuilder
        > {
  _$WarehouseIndexItems227200Response? _$v;
  ...
  WarehouseIndexItems227200ResponseBuilder() {
    WarehouseIndexItems227200Response._defaults(this);
  }

  WarehouseIndexItems227200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexItems227200Response other) {
    _$v = other as _$WarehouseIndexItems227200Response;
  }
  ...
  @override
  WarehouseIndexItems227200Response build() => _build();

  _$WarehouseIndexItems227200Response _build() {
    _$WarehouseIndexItems227200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexItems227200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexItems227200Response',
              'currentPage',
            ),
            data: data.build(),
