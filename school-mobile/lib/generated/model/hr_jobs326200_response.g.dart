...
part of 'hr_jobs326200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrJobs326200Response extends HrJobs326200Response {
  @override
  ...
  factory _$HrJobs326200Response([
    void Function(HrJobs326200ResponseBuilder)? updates,
  ]) => (HrJobs326200ResponseBuilder()..update(updates))._build();

  _$HrJobs326200Response._({
  ...
  @override
  HrJobs326200Response rebuild(
    void Function(HrJobs326200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrJobs326200ResponseBuilder toBuilder() =>
      HrJobs326200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrJobs326200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrJobs326200Response')
...
class HrJobs326200ResponseBuilder
    implements Builder<HrJobs326200Response, HrJobs326200ResponseBuilder> {
  _$HrJobs326200Response? _$v;
  ...
  HrJobs326200ResponseBuilder() {
    HrJobs326200Response._defaults(this);
  }

  HrJobs326200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrJobs326200Response other) {
    _$v = other as _$HrJobs326200Response;
  }

  @override
  void update(void Function(HrJobs326200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrJobs326200Response build() => _build();

  _$HrJobs326200Response _build() {
    _$HrJobs326200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrJobs326200Response._(
