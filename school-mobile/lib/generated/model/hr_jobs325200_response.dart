...
part 'hr_jobs325200_response.g.dart';
...
@BuiltValue()
abstract class HrJobs325200Response implements Built<HrJobs325200Response, HrJobs325200ResponseBuilder> {
  ...
  HrJobs325200Response._();

  factory HrJobs325200Response([void updates(HrJobs325200ResponseBuilder b)]) = _$HrJobs325200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrJobs325200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrJobs325200Response> get serializer => _$HrJobs325200ResponseSerializer();
}

class _$HrJobs325200ResponseSerializer implements PrimitiveSerializer<HrJobs325200Response> {
  @override
  final Iterable<Type> types = const [HrJobs325200Response, _$HrJobs325200Response];

  @override
  final String wireName = r'HrJobs325200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrJobs325200Response object, {
  ...
  void _deserializeProperties(
    ...
    required HrJobs325200ResponseBuilder result,
  ...
  @override
  HrJobs325200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrJobs325200ResponseBuilder();
