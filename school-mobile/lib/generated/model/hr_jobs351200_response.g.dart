...
part of 'hr_jobs351200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrJobs351200Response extends HrJobs351200Response {
  @override
  ...
  factory _$HrJobs351200Response([
    void Function(HrJobs351200ResponseBuilder)? updates,
  ]) => (HrJobs351200ResponseBuilder()..update(updates))._build();

  _$HrJobs351200Response._({
  ...
  @override
  HrJobs351200Response rebuild(
    void Function(HrJobs351200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrJobs351200ResponseBuilder toBuilder() =>
      HrJobs351200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrJobs351200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrJobs351200Response')
...
class HrJobs351200ResponseBuilder
    implements Builder<HrJobs351200Response, HrJobs351200ResponseBuilder> {
  _$HrJobs351200Response? _$v;
  ...
  HrJobs351200ResponseBuilder() {
    HrJobs351200Response._defaults(this);
  }

  HrJobs351200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrJobs351200Response other) {
    _$v = other as _$HrJobs351200Response;
  }

  @override
  void update(void Function(HrJobs351200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrJobs351200Response build() => _build();

  _$HrJobs351200Response _build() {
    _$HrJobs351200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrJobs351200Response._(
