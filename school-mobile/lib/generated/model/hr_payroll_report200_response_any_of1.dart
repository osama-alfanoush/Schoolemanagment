...
part 'hr_payroll_report200_response_any_of1.g.dart';
...
@BuiltValue()
abstract class HrPayrollReport200ResponseAnyOf1 implements Built<HrPayrollReport200ResponseAnyOf1, HrPayrollReport200ResponseAnyOf1Builder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<PayrollRun> get data;
  ...
  HrPayrollReport200ResponseAnyOf1._();

  factory HrPayrollReport200ResponseAnyOf1([void updates(HrPayrollReport200ResponseAnyOf1Builder b)]) = _$HrPayrollReport200ResponseAnyOf1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrPayrollReport200ResponseAnyOf1Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrPayrollReport200ResponseAnyOf1> get serializer => _$HrPayrollReport200ResponseAnyOf1Serializer();
}

class _$HrPayrollReport200ResponseAnyOf1Serializer implements PrimitiveSerializer<HrPayrollReport200ResponseAnyOf1> {
  @override
  final Iterable<Type> types = const [HrPayrollReport200ResponseAnyOf1, _$HrPayrollReport200ResponseAnyOf1];

  @override
  final String wireName = r'HrPayrollReport200ResponseAnyOf1';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrPayrollReport200ResponseAnyOf1 object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(PayrollRun)]),
    );
  ...
  void _deserializeProperties(
    ...
    required HrPayrollReport200ResponseAnyOf1Builder result,
  ...
  @override
  HrPayrollReport200ResponseAnyOf1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrPayrollReport200ResponseAnyOf1Builder();
