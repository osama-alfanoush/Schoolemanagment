...
part 'hr_evaluations200_response.g.dart';
...
@BuiltValue()
abstract class HrEvaluations200Response implements Built<HrEvaluations200Response, HrEvaluations200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<PerformanceEvaluation> get data;
  ...
  HrEvaluations200Response._();

  factory HrEvaluations200Response([void updates(HrEvaluations200ResponseBuilder b)]) = _$HrEvaluations200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrEvaluations200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrEvaluations200Response> get serializer => _$HrEvaluations200ResponseSerializer();
}

class _$HrEvaluations200ResponseSerializer implements PrimitiveSerializer<HrEvaluations200Response> {
  @override
  final Iterable<Type> types = const [HrEvaluations200Response, _$HrEvaluations200Response];

  @override
  final String wireName = r'HrEvaluations200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrEvaluations200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(PerformanceEvaluation)]),
    );
  ...
  void _deserializeProperties(
    ...
    required HrEvaluations200ResponseBuilder result,
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(PerformanceEvaluation)]),
          ) as BuiltList<PerformanceEvaluation>;
  ...
  @override
  HrEvaluations200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrEvaluations200ResponseBuilder();
