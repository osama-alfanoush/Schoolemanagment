...
part 'library_available_books200_response.g.dart';
...
@BuiltValue()
abstract class LibraryAvailableBooks200Response implements Built<LibraryAvailableBooks200Response, LibraryAvailableBooks200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<LibraryBook> get data;
  ...
  LibraryAvailableBooks200Response._();

  factory LibraryAvailableBooks200Response([void updates(LibraryAvailableBooks200ResponseBuilder b)]) = _$LibraryAvailableBooks200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LibraryAvailableBooks200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LibraryAvailableBooks200Response> get serializer => _$LibraryAvailableBooks200ResponseSerializer();
}

class _$LibraryAvailableBooks200ResponseSerializer implements PrimitiveSerializer<LibraryAvailableBooks200Response> {
  @override
  final Iterable<Type> types = const [LibraryAvailableBooks200Response, _$LibraryAvailableBooks200Response];

  @override
  final String wireName = r'LibraryAvailableBooks200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LibraryAvailableBooks200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(LibraryBook)]),
    );
  ...
  void _deserializeProperties(
    ...
    required LibraryAvailableBooks200ResponseBuilder result,
  ...
  @override
  LibraryAvailableBooks200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LibraryAvailableBooks200ResponseBuilder();
