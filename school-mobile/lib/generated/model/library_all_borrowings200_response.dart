...
part 'library_all_borrowings200_response.g.dart';
...
@BuiltValue()
abstract class LibraryAllBorrowings200Response implements Built<LibraryAllBorrowings200Response, LibraryAllBorrowings200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<LibraryBorrowing> get data;
  ...
  LibraryAllBorrowings200Response._();

  factory LibraryAllBorrowings200Response([void updates(LibraryAllBorrowings200ResponseBuilder b)]) = _$LibraryAllBorrowings200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LibraryAllBorrowings200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LibraryAllBorrowings200Response> get serializer => _$LibraryAllBorrowings200ResponseSerializer();
}

class _$LibraryAllBorrowings200ResponseSerializer implements PrimitiveSerializer<LibraryAllBorrowings200Response> {
  @override
  final Iterable<Type> types = const [LibraryAllBorrowings200Response, _$LibraryAllBorrowings200Response];

  @override
  final String wireName = r'LibraryAllBorrowings200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LibraryAllBorrowings200Response object, {
  ...
  void _deserializeProperties(
    ...
    required LibraryAllBorrowings200ResponseBuilder result,
  ...
  @override
  LibraryAllBorrowings200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LibraryAllBorrowings200ResponseBuilder();
