...
part 'hr_jobs342200_response.g.dart';
...
@BuiltValue()
abstract class HrJobs342200Response implements Built<HrJobs342200Response, HrJobs342200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<JobPosting> get data;
  ...
  HrJobs342200Response._();

  factory HrJobs342200Response([void updates(HrJobs342200ResponseBuilder b)]) = _$HrJobs342200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrJobs342200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrJobs342200Response> get serializer => _$HrJobs342200ResponseSerializer();
}

class _$HrJobs342200ResponseSerializer implements PrimitiveSerializer<HrJobs342200Response> {
  @override
  final Iterable<Type> types = const [HrJobs342200Response, _$HrJobs342200Response];

  @override
  final String wireName = r'HrJobs342200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrJobs342200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(JobPosting)]),
    );
  ...
  void _deserializeProperties(
    ...
    required HrJobs342200ResponseBuilder result,
  ...
  @override
  HrJobs342200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrJobs342200ResponseBuilder();
