...
part of 'hr_jobs337200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrJobs337200Response extends HrJobs337200Response {
  @override
  ...
  factory _$HrJobs337200Response([
    void Function(HrJobs337200ResponseBuilder)? updates,
  ]) => (HrJobs337200ResponseBuilder()..update(updates))._build();

  _$HrJobs337200Response._({
  ...
  @override
  HrJobs337200Response rebuild(
    void Function(HrJobs337200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrJobs337200ResponseBuilder toBuilder() =>
      HrJobs337200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrJobs337200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrJobs337200Response')
...
class HrJobs337200ResponseBuilder
    implements Builder<HrJobs337200Response, HrJobs337200ResponseBuilder> {
  _$HrJobs337200Response? _$v;
  ...
  HrJobs337200ResponseBuilder() {
    HrJobs337200Response._defaults(this);
  }

  HrJobs337200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrJobs337200Response other) {
    _$v = other as _$HrJobs337200Response;
  }

  @override
  void update(void Function(HrJobs337200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrJobs337200Response build() => _build();

  _$HrJobs337200Response _build() {
    _$HrJobs337200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrJobs337200Response._(
