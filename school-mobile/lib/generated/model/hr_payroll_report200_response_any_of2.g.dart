...
part of 'hr_payroll_report200_response_any_of2.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrPayrollReport200ResponseAnyOf2
    extends HrPayrollReport200ResponseAnyOf2 {
  @override
  final int currentPage;
  @override
  final BuiltList<PayrollRecord> data;
  @override
  ...
  factory _$HrPayrollReport200ResponseAnyOf2([
    void Function(HrPayrollReport200ResponseAnyOf2Builder)? updates,
  ]) => (HrPayrollReport200ResponseAnyOf2Builder()..update(updates))._build();

  _$HrPayrollReport200ResponseAnyOf2._({
  ...
  @override
  HrPayrollReport200ResponseAnyOf2 rebuild(
    void Function(HrPayrollReport200ResponseAnyOf2Builder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrPayrollReport200ResponseAnyOf2Builder toBuilder() =>
      HrPayrollReport200ResponseAnyOf2Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrPayrollReport200ResponseAnyOf2 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrPayrollReport200ResponseAnyOf2')
...
class HrPayrollReport200ResponseAnyOf2Builder
    implements
        Builder<
          HrPayrollReport200ResponseAnyOf2,
          HrPayrollReport200ResponseAnyOf2Builder
        > {
  _$HrPayrollReport200ResponseAnyOf2? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<PayrollRecord>? _data;
  ListBuilder<PayrollRecord> get data =>
      _$this._data ??= ListBuilder<PayrollRecord>();
  set data(ListBuilder<PayrollRecord>? data) => _$this._data = data;
  ...
  HrPayrollReport200ResponseAnyOf2Builder() {
    HrPayrollReport200ResponseAnyOf2._defaults(this);
  }

  HrPayrollReport200ResponseAnyOf2Builder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrPayrollReport200ResponseAnyOf2 other) {
    _$v = other as _$HrPayrollReport200ResponseAnyOf2;
  }

  @override
  void update(void Function(HrPayrollReport200ResponseAnyOf2Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrPayrollReport200ResponseAnyOf2 build() => _build();

  _$HrPayrollReport200ResponseAnyOf2 _build() {
    _$HrPayrollReport200ResponseAnyOf2 _$result;
    try {
      _$result =
          _$v ??
          _$HrPayrollReport200ResponseAnyOf2._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'HrPayrollReport200ResponseAnyOf2',
              'currentPage',
            ),
            data: data.build(),
