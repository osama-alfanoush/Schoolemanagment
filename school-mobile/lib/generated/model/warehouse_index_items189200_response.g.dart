...
part of 'warehouse_index_items189200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WarehouseIndexItems189200Response
    extends WarehouseIndexItems189200Response {
  @override
  ...
  factory _$WarehouseIndexItems189200Response([
    void Function(WarehouseIndexItems189200ResponseBuilder)? updates,
  ]) => (WarehouseIndexItems189200ResponseBuilder()..update(updates))._build();

  _$WarehouseIndexItems189200Response._({
  ...
  @override
  WarehouseIndexItems189200Response rebuild(
    void Function(WarehouseIndexItems189200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  WarehouseIndexItems189200ResponseBuilder toBuilder() =>
      WarehouseIndexItems189200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WarehouseIndexItems189200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WarehouseIndexItems189200Response')
...
class WarehouseIndexItems189200ResponseBuilder
    implements
        Builder<
          WarehouseIndexItems189200Response,
          WarehouseIndexItems189200ResponseBuilder
        > {
  _$WarehouseIndexItems189200Response? _$v;
  ...
  WarehouseIndexItems189200ResponseBuilder() {
    WarehouseIndexItems189200Response._defaults(this);
  }

  WarehouseIndexItems189200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WarehouseIndexItems189200Response other) {
    _$v = other as _$WarehouseIndexItems189200Response;
  }
  ...
  @override
  WarehouseIndexItems189200Response build() => _build();

  _$WarehouseIndexItems189200Response _build() {
    _$WarehouseIndexItems189200Response _$result;
    try {
      _$result =
          _$v ??
          _$WarehouseIndexItems189200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'WarehouseIndexItems189200Response',
              'currentPage',
            ),
            data: data.build(),
