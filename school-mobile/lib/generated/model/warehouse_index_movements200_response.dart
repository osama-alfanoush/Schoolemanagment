...
part 'warehouse_index_movements200_response.g.dart';
...
@BuiltValue()
abstract class WarehouseIndexMovements200Response implements Built<WarehouseIndexMovements200Response, WarehouseIndexMovements200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<StockMovement> get data;
  ...
  WarehouseIndexMovements200Response._();

  factory WarehouseIndexMovements200Response([void updates(WarehouseIndexMovements200ResponseBuilder b)]) = _$WarehouseIndexMovements200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WarehouseIndexMovements200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WarehouseIndexMovements200Response> get serializer => _$WarehouseIndexMovements200ResponseSerializer();
}

class _$WarehouseIndexMovements200ResponseSerializer implements PrimitiveSerializer<WarehouseIndexMovements200Response> {
  @override
  final Iterable<Type> types = const [WarehouseIndexMovements200Response, _$WarehouseIndexMovements200Response];

  @override
  final String wireName = r'WarehouseIndexMovements200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WarehouseIndexMovements200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(StockMovement)]),
    );
  ...
  void _deserializeProperties(
    ...
    required WarehouseIndexMovements200ResponseBuilder result,
  ...
  @override
  WarehouseIndexMovements200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WarehouseIndexMovements200ResponseBuilder();
