...
part of 'admin_list_users200_response_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AdminListUsers200ResponseData extends AdminListUsers200ResponseData {
  @override
  ...
  factory _$AdminListUsers200ResponseData([
    void Function(AdminListUsers200ResponseDataBuilder)? updates,
  ]) => (AdminListUsers200ResponseDataBuilder()..update(updates))._build();

  _$AdminListUsers200ResponseData._({
  ...
  @override
  AdminListUsers200ResponseData rebuild(
    void Function(AdminListUsers200ResponseDataBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  AdminListUsers200ResponseDataBuilder toBuilder() =>
      AdminListUsers200ResponseDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AdminListUsers200ResponseData &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdminListUsers200ResponseData')
...
class AdminListUsers200ResponseDataBuilder
    implements
        Builder<
          AdminListUsers200ResponseData,
          AdminListUsers200ResponseDataBuilder
        > {
  _$AdminListUsers200ResponseData? _$v;
  ...
  AdminListUsers200ResponseDataBuilder() {
    AdminListUsers200ResponseData._defaults(this);
  }

  AdminListUsers200ResponseDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(AdminListUsers200ResponseData other) {
    _$v = other as _$AdminListUsers200ResponseData;
  }

  @override
  void update(void Function(AdminListUsers200ResponseDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AdminListUsers200ResponseData build() => _build();

  _$AdminListUsers200ResponseData _build() {
    _$AdminListUsers200ResponseData _$result;
    try {
      _$result =
          _$v ??
          _$AdminListUsers200ResponseData._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'AdminListUsers200ResponseData',
              'currentPage',
            ),
            data: data.build(),
