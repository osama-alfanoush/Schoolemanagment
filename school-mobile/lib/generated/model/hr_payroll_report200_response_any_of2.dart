...
part 'hr_payroll_report200_response_any_of2.g.dart';
...
@BuiltValue()
abstract class HrPayrollReport200ResponseAnyOf2 implements Built<HrPayrollReport200ResponseAnyOf2, HrPayrollReport200ResponseAnyOf2Builder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<PayrollRecord> get data;
  ...
  HrPayrollReport200ResponseAnyOf2._();

  factory HrPayrollReport200ResponseAnyOf2([void updates(HrPayrollReport200ResponseAnyOf2Builder b)]) = _$HrPayrollReport200ResponseAnyOf2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrPayrollReport200ResponseAnyOf2Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrPayrollReport200ResponseAnyOf2> get serializer => _$HrPayrollReport200ResponseAnyOf2Serializer();
}

class _$HrPayrollReport200ResponseAnyOf2Serializer implements PrimitiveSerializer<HrPayrollReport200ResponseAnyOf2> {
  @override
  final Iterable<Type> types = const [HrPayrollReport200ResponseAnyOf2, _$HrPayrollReport200ResponseAnyOf2];

  @override
  final String wireName = r'HrPayrollReport200ResponseAnyOf2';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrPayrollReport200ResponseAnyOf2 object, {
  ...
  void _deserializeProperties(
    ...
    required HrPayrollReport200ResponseAnyOf2Builder result,
  ...
  @override
  HrPayrollReport200ResponseAnyOf2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrPayrollReport200ResponseAnyOf2Builder();
