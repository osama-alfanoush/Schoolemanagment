...
part 'hr_payroll_advances200_response.g.dart';
...
@BuiltValue()
abstract class HrPayrollAdvances200Response implements Built<HrPayrollAdvances200Response, HrPayrollAdvances200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<EmployeeAdvance> get data;
  ...
  HrPayrollAdvances200Response._();

  factory HrPayrollAdvances200Response([void updates(HrPayrollAdvances200ResponseBuilder b)]) = _$HrPayrollAdvances200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HrPayrollAdvances200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HrPayrollAdvances200Response> get serializer => _$HrPayrollAdvances200ResponseSerializer();
}

class _$HrPayrollAdvances200ResponseSerializer implements PrimitiveSerializer<HrPayrollAdvances200Response> {
  @override
  final Iterable<Type> types = const [HrPayrollAdvances200Response, _$HrPayrollAdvances200Response];

  @override
  final String wireName = r'HrPayrollAdvances200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HrPayrollAdvances200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(EmployeeAdvance)]),
    );
  ...
  void _deserializeProperties(
    ...
    required HrPayrollAdvances200ResponseBuilder result,
  ...
  @override
  HrPayrollAdvances200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HrPayrollAdvances200ResponseBuilder();
