...
part 'procurement_supplier_transactions200_response.g.dart';
...
@BuiltValue()
abstract class ProcurementSupplierTransactions200Response implements Built<ProcurementSupplierTransactions200Response, ProcurementSupplierTransactions200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<SupplierTransaction> get data;
  ...
  ProcurementSupplierTransactions200Response._();

  factory ProcurementSupplierTransactions200Response([void updates(ProcurementSupplierTransactions200ResponseBuilder b)]) = _$ProcurementSupplierTransactions200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProcurementSupplierTransactions200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProcurementSupplierTransactions200Response> get serializer => _$ProcurementSupplierTransactions200ResponseSerializer();
}

class _$ProcurementSupplierTransactions200ResponseSerializer implements PrimitiveSerializer<ProcurementSupplierTransactions200Response> {
  @override
  final Iterable<Type> types = const [ProcurementSupplierTransactions200Response, _$ProcurementSupplierTransactions200Response];

  @override
  final String wireName = r'ProcurementSupplierTransactions200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ProcurementSupplierTransactions200Response object, {
    ...
    yield serializers.serialize(
      object.data,
      specifiedType: const FullType(BuiltList, [FullType(SupplierTransaction)]),
    );
  ...
  void _deserializeProperties(
    ...
    required ProcurementSupplierTransactions200ResponseBuilder result,
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(SupplierTransaction)]),
          ) as BuiltList<SupplierTransaction>;
  ...
  @override
  ProcurementSupplierTransactions200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProcurementSupplierTransactions200ResponseBuilder();
