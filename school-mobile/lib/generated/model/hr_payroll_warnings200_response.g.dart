...
part of 'hr_payroll_warnings200_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HrPayrollWarnings200Response extends HrPayrollWarnings200Response {
  @override
  final int currentPage;
  @override
  final BuiltList<DisciplinaryWarning> data;
  @override
  ...
  factory _$HrPayrollWarnings200Response([
    void Function(HrPayrollWarnings200ResponseBuilder)? updates,
  ]) => (HrPayrollWarnings200ResponseBuilder()..update(updates))._build();

  _$HrPayrollWarnings200Response._({
  ...
  @override
  HrPayrollWarnings200Response rebuild(
    void Function(HrPayrollWarnings200ResponseBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  HrPayrollWarnings200ResponseBuilder toBuilder() =>
      HrPayrollWarnings200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HrPayrollWarnings200Response &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HrPayrollWarnings200Response')
...
class HrPayrollWarnings200ResponseBuilder
    implements
        Builder<
          HrPayrollWarnings200Response,
          HrPayrollWarnings200ResponseBuilder
        > {
  _$HrPayrollWarnings200Response? _$v;

  int? _currentPage;
  int? get currentPage => _$this._currentPage;
  set currentPage(int? currentPage) => _$this._currentPage = currentPage;

  ListBuilder<DisciplinaryWarning>? _data;
  ListBuilder<DisciplinaryWarning> get data =>
      _$this._data ??= ListBuilder<DisciplinaryWarning>();
  set data(ListBuilder<DisciplinaryWarning>? data) => _$this._data = data;
  ...
  HrPayrollWarnings200ResponseBuilder() {
    HrPayrollWarnings200Response._defaults(this);
  }

  HrPayrollWarnings200ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HrPayrollWarnings200Response other) {
    _$v = other as _$HrPayrollWarnings200Response;
  }

  @override
  void update(void Function(HrPayrollWarnings200ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HrPayrollWarnings200Response build() => _build();

  _$HrPayrollWarnings200Response _build() {
    _$HrPayrollWarnings200Response _$result;
    try {
      _$result =
          _$v ??
          _$HrPayrollWarnings200Response._(
            currentPage: BuiltValueNullFieldError.checkNotNull(
              currentPage,
              r'HrPayrollWarnings200Response',
              'currentPage',
            ),
            data: data.build(),
