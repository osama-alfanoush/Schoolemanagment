...
part 'admin_get_announcements200_response.g.dart';
...
@BuiltValue()
abstract class AdminGetAnnouncements200Response implements Built<AdminGetAnnouncements200Response, AdminGetAnnouncements200ResponseBuilder> {
  @BuiltValueField(wireName: r'current_page')
  int get currentPage;

  @BuiltValueField(wireName: r'data')
  BuiltList<Announcement> get data;
  ...
  AdminGetAnnouncements200Response._();

  factory AdminGetAnnouncements200Response([void updates(AdminGetAnnouncements200ResponseBuilder b)]) = _$AdminGetAnnouncements200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdminGetAnnouncements200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdminGetAnnouncements200Response> get serializer => _$AdminGetAnnouncements200ResponseSerializer();
}

class _$AdminGetAnnouncements200ResponseSerializer implements PrimitiveSerializer<AdminGetAnnouncements200Response> {
  @override
  final Iterable<Type> types = const [AdminGetAnnouncements200Response, _$AdminGetAnnouncements200Response];

  @override
  final String wireName = r'AdminGetAnnouncements200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AdminGetAnnouncements200Response object, {
  ...
  void _deserializeProperties(
    ...
    required AdminGetAnnouncements200ResponseBuilder result,
  ...
  @override
  AdminGetAnnouncements200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AdminGetAnnouncements200ResponseBuilder();
